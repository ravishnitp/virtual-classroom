  ...
  <div class="main">
    <div class="col l6 offset-l3 m8 offset-m2 s12" id="login" style="margin:20px;">
      <div class="card-panel center  teal lighten-5" style="margin-top:1px">
        <h5 style="font-variant: small-caps; font-weight: bold;">Add&nbsp;Student</h5>
		<?php
        ...
        <form action="addStudents.php" method="POST">
          ...
          <div class="input-field">
            ...
            <input type="number" min="1900" max="2099" step="1" value="2018" name="sYear" required/>
     ...
     if(isset($_POST['submit'])) //
     {
         ...
         */
         ...
         else
         {
                 ...
                 $sql="insert into students (email,username,password,department,name,phoneNumber,sYear) values('$email','$username','$password','$department','$name',$phoneNumber,'$sYear')";
                 $res=mysqli_query($conn,$sql);
                 if($res)
                 {
                     header("Location: addStudents.php");
                     $_SESSION['message']="<div class='chip green white-text'>Student Successfully Added</div>";
                 }
                 else
                 {
                     header("Location: addStudents.php");
