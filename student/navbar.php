    ...
    <body>
        ...
        <nav class="blue">
            <div class="nav-wrapper">
                <div class="container">
                    ...
                    <a href="" class="brand-logo right ">Student</a>
        ...
        <ul class="side-nav fixed" id="sidenav">
            ...
            <?php
									...
									$sql="select image from students where username='$user'";
                ...
                <div class="user-view">
                    ...
                    <span class="white-text name"> <?php echo $_SESSION['susername'];?> </span>
            ...
            <li >
                <a href="studentDashboard.php" ><i class="material-icons blue-text">dashboard</i>Dashboard</a>
            </li>
            <li >
             ...
             <li>
                <a href="myClassroom.php" ><i class="material-icons blue-text">assignment</i>My&nbsp;Classroom</a>
             </li>
             <li>
                <a href="takeTest.php" ><i class="material-icons blue-text">code</i>Take&nbsp;Test</a>
             </li>

             <li>
                <a href="takeAssignment.php" ><i class="material-icons blue-text">list</i>Submit&nbsp;Assignment</a>
             </li>

              <li>
                <a href="viewMarks.php" ><i class="material-icons blue-text">visibility</i>View&nbsp;Test&nbsp;Marks</a>
             </li>

             <li>
                <a href="askDoubt.php" ><i class="material-icons blue-text">question_answer</i>Ask&nbsp;Doubts</a>
             </li>
							...
							<div class="col l6 offset-l3 m8 offset-m2 s12"  style="margin:20px;">
								<div class="card-panel center  teal lighten-5" style="margin-top:1px">
									...
									<div class="modal-footer teal lighten-5"">
									 <a href="studentDashboard.php" class="btn-floating btn-large waves-effect waves-light red"><i class="medium material-icons white-text">cancel</i></a>
									</div>
								</div>
							</div>
						</div>
							...
							$filepath = "images/" . $_FILES["file"]["name"];
							  ...
							  if($type =="image/jpeg" || $type=="image/png" || $type=="image/jpg")
							  {
								  if(move_uploaded_file($_FILES["file"]["tmp_name"], $filepath)) 
								{
									...
									$sql="update students set image='$img' where username='$username'";
									$res=mysqli_query($conn,$sql);
