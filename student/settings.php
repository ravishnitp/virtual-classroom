...
if(isset($_POST['update']))
{
  ...
  if($conf_password===$password)
  {
    ...
    if($res)
    {
        $_SESSION['smessage']="<div class='chip green white-text'>Password Successfully Changed.</div>";
        header("Location: settings.php");
    }
    else
    {
        $_SESSION['smessage']="<div class='chip red black-text'>Sorry, Something went wrong, Please Try Again.</div>";
        header("Location: settings.php");
  }
}
else
{
  $_SESSION['smessage']="<div class='chip red black-text'>Password donot Match.</div>";
  header("Location: settings.php");
}
}
?>