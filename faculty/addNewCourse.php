...
{ 
			...
			if($diff5->format("%R%a days") < 0)
			{
               ...
               $_SESSION['fcourseAddmessage']="<div class='chip red black-text'>Course Time Expired</div>";
			...
			{
				header("Location: addCourse.php");
             $_SESSION['fcourseAddmessage']="<div class='chip red black-text'>Ongoing Course</div>";
			 die("ongoing Course");
			...
			{
				header("Location: addCourse.php");
             $_SESSION['fcourseAddmessage']="<div class='chip red black-text'>Course Exist</div>";
			 die("Course Exist ");
			}
		  ...
		  */
		  ...
		  {
			  header("Location: addCourse.php");
             $_SESSION['fcourseAddmessage']="<div class='chip red black-text'>Error Adding Course</div>";
		...
		for ($x = 1; $x <= $numberOfDoc; $x++) 
		{
			...
			if (!empty($file_name))
			  ...
			  echo "<br>";
				...
				header("Location: addCourse.php");
             $_SESSION['fcourseAddmessage']="<div class='chip green white-text'>Course Added</div>";
